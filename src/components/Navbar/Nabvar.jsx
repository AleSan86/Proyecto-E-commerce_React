                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                      <Link to={`/categoria/1`} className="dropdown-item">Bazar </Link>
                      <Link to={`/categoria/2`} className="dropdown-item">Cocina </Link>
                      <Link to={`/categoria/3`} className="dropdown-item">Artículos </Link>
                    </ul>
                  </li>
